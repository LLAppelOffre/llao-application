...
var withAnimated = (Component2, host4) => {
  const hasInstance = (
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    const [props, deps] = getAnimatedState(givenProps, host4);
    ...
    const callback = () => {
      ...
      const didUpdate = instance ? host4.applyAnimatedValues(instance, props.getValue(true)) : false;
      if (didUpdate === false) {
        forceUpdate();
      }
    };
    ...
    const usedProps = host4.getComponentProps(props.getValue());
...
function getAnimatedState(props, host4) {
  const dependencies = /* @__PURE__ */ new Set();
  TreeContext.dependencies = dependencies;
  if (props.style)
    props = {
      ...props,
      style: host4.createAnimatedStyle(props.style)
    };
...
var createHost = (components, {
  applyAnimatedValues: applyAnimatedValues4 = () => false,
  ...
  const animated4 = (Component2) => {
    const displayName = getDisplayName(Component2) || "Anonymous";
    if (is.str(Component2)) {
      Component2 = animated4[Component2] || (animated4[Component2] = withAnimated(Component2, hostConfig));
    } else {
  ...
  eachProp(components, (Component2, key) => {
    ...
    animated4[key] = animated4(Component2);
  });
  return {
    animated: animated4
  };
...
var isValueIdentity2 = (value, id) => is.arr(value) ? value.every((v3) => isValueIdentity2(v3, id)) : is.num(value) ? value === id : parseFloat(value) === id;
var AnimatedStyle2 = class extends AnimatedObject {
  constructor({ x: x3, y: y5, z: z5, ...style }) {
    ...
    if (x3 || y5 || z5) {
      inputs.push([x3 || 0, y5 || 0, z5 || 0]);
      transforms.push((xyz) => [
        `translate3d(${xyz.map((v3) => addUnit2(v3, "px")).join(",")})`,
        // prettier-ignore
      ...
      if (key === "transform") {
        ...
        transforms.push(
          key === "rotate3d" ? ([x22, y22, z22, deg]) => [
            ...
            `${key}(${input.map((v3) => addUnit2(v3, unit2)).join(",")})`,
...
function hslConvert(o5) {
  ...
  o5 = o5.rgb();
  var r5 = o5.r / 255, g2 = o5.g / 255, b5 = o5.b / 255, min3 = Math.min(r5, g2, b5), max3 = Math.max(r5, g2, b5), h2 = NaN, s6 = max3 - min3, l5 = (max3 + min3) / 2;
  if (s6) {
    if (r5 === max3) h2 = (g2 - b5) / s6 + (g2 < b5) * 6;
    else if (g2 === max3) h2 = (b5 - r5) / s6 + 2;
    else h2 = (r5 - g2) / s6 + 4;
    s6 /= l5 < 0.5 ? max3 + min3 : 2 - max3 - min3;
    h2 *= 60;
  } else {
    s6 = l5 > 0 && l5 < 1 ? 0 : h2;
  }
...
function pie_default() {
  ...
  function pie(data) {
    var i5, n6 = (data = array_default2(data)).length, j4, k4, sum3 = 0, index2 = new Array(n6), arcs = new Array(n6), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p4 = Math.min(Math.abs(da) / n6, padAngle.apply(this, arguments)), pa = p4 * (da < 0 ? -1 : 1), v3;
    for (i5 = 0; i5 < n6; ++i5) {
      if ((v3 = arcs[index2[i5] = i5] = +value(data[i5], i5, data)) > 0) {
        sum3 += v3;
      }
    }
    if (sortValues != null) index2.sort(function(i6, j5) {
      return sortValues(arcs[i6], arcs[j5]);
    });
    else if (sort2 != null) index2.sort(function(i6, j5) {
      return sort2(data[i6], data[j5]);
    });
    for (i5 = 0, k4 = sum3 ? (da - n6 * pa) / sum3 : 0; i5 < n6; ++i5, a0 = a1) {
      j4 = index2[i5], v3 = arcs[j4], a1 = a0 + (v3 > 0 ? v3 * k4 : 0) + pa, arcs[j4] = {
        data: data[j4],
        index: i5,
        value: v3,
        startAngle: a0,
...
function blurf(radius) {
  ...
  return (T2, S3, start2, stop2, step) => {
    ...
    for (let i5 = start2, j4 = stop2; i5 <= j4; i5 += step) {
      ...
      T2[i5] = (sum3 + t7 * (S3[Math.max(start2, i5 - s1)] + S3[Math.min(stop2, i5 + s1)])) / w3;
...
function bluri(radius) {
  ...
  return (T2, S3, start2, stop2, step) => {
    ...
    for (let i5 = start2, j4 = stop2; i5 <= j4; i5 += step) {
      sum3 += S3[Math.min(stop2, i5 + s6)];
      T2[i5] = sum3 / w3;
      sum3 -= S3[Math.max(start2, i5 - s6)];
    }
  };
}
...
function shuffler(random) {
  return function shuffle(array2, i0 = 0, i1 = array2.length) {
    let m3 = i1 - (i0 = +i0);
    while (m3) {
      const i5 = random() * m3-- | 0, t7 = array2[m3 + i0];
...
function ordinal() {
  ...
  function scale(d5) {
    let i5 = index2.get(d5);
    if (i5 === void 0) {
      if (unknown !== implicit) return unknown;
      index2.set(d5, i5 = domain.push(d5) - 1);
    }
...
function locale_default(locale3) {
  ...
  function formatPrefix2(specifier, value) {
    var f2 = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e8 = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k4 = Math.pow(10, -e8), prefix2 = prefixes3[8 + e8 / 3];
...
var Ct = (0, import_react18.memo)(function(e8) {
  ...
  return (0, import_jsx_runtime2.jsxs)(animated2.g, { transform: q.transform, style: { pointerEvents: "none" }, focusable: C5, tabIndex: C5 ? P3 : void 0, "aria-label": m3, "aria-labelledby": _2, "aria-describedby": w3, "aria-disabled": R3, "aria-hidden": O4, onFocus: C5 && W3 ? D2 : void 0, onBlur: C5 && G ? E4 : void 0, "data-testid": I, children: [(0, import_react18.createElement)(o5, { size: a6, color: u5, datum: l5, borderWidth: c10, borderColor: s6 }), f2 && (0, import_jsx_runtime2.jsx)("text", { textAnchor: p4, y: b5, style: b(A4.dots.text), children: f2 })] });
});
      ...
      if (zn(a8, r6, i5)) {
        ...
        if (d6) {
          if (On.includes(d6.type)) if ("inherit" === d6.background || "inherit" === d6.color) {
            ...
            "inherit" === d6.background && (g2 = g2 + ".bg." + f2, h2 = f2), "inherit" === d6.color && (g2 = g2 + ".fg." + f2, p4 = f2), (0, import_set2.default)(r6, u5, "url(#" + g2 + ")"), s6[g2] || (c10.push(Vr({}, d6, { id: g2, background: h2, color: p4 })), s6[g2] = 1);
          } else (0, import_set2.default)(r6, u5, "url(#" + o7 + ")");
            ...
            if (d6.colors.map(function(e9) {
              ...
              v3.id = m3, (0, import_set2.default)(r6, u5, "url(#" + m3 + ")"), s6[m3] || (c10.push(v3), s6[m3] = 1);
            } else (0, import_set2.default)(r6, u5, "url(#" + o7 + ")");
          }
        }
        return 1;
...
var isValueIdentity3 = (value, id) => is.arr(value) ? value.every((v3) => isValueIdentity3(v3, id)) : is.num(value) ? value === id : parseFloat(value) === id;
var AnimatedStyle3 = class extends AnimatedObject {
  constructor({ x: x3, y: y5, z: z5, ...style }) {
    ...
    if (x3 || y5 || z5) {
      inputs.push([x3 || 0, y5 || 0, z5 || 0]);
      transforms.push((xyz) => [
        `translate3d(${xyz.map((v3) => addUnit3(v3, "px")).join(",")})`,
        // prettier-ignore
      ...
      if (key === "transform") {
        ...
        transforms.push(
          key === "rotate3d" ? ([x22, y22, z22, deg]) => [
            ...
            `${key}(${input.map((v3) => addUnit3(v3, unit2)).join(",")})`,
...
var b3 = function(r5) {
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [f2 > 0 && (0, import_jsx_runtime4.jsx)(animated3.text, p2({}, c10, { style: p2({}, d5, { strokeWidth: 2 * f2, stroke: u5, strokeOpacity: a6, strokeLinejoin: "round" }), children: l5 })), (0, import_jsx_runtime4.jsx)(animated3.text, p2({}, c10, { style: d5, children: l5 }))] });
};
...
//# sourceMappingURL=chunk-PXGDOMXJ.js.map
