...
export declare const defaultProps: {
    ...
    tooltip: ({ color, label, formatted }: import("./types").BoxPlotTooltipProps) => import("react/jsx-runtime").JSX.Element;
