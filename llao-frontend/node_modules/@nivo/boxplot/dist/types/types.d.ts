...
import { ScaleBandSpec, AnyScale, ScaleLinearSpec, ScaleLogSpec, ScaleSymlogSpec, ScaleTimeSpec } from '@nivo/scales';
...
export interface BoxPlotCustomLayerProps<RawDatum> extends Pick<BoxPlotCommonProps<RawDatum>, 'layout' | 'borderRadius' | 'borderWidth' | 'medianWidth' | 'whiskerWidth' | 'whiskerEndSize' | 'isInteractive' | 'padding' | 'innerPadding'>, Dimensions, BoxPlotHandlers<SVGRectElement> {
...
export interface BoxPlotItemProps<RawDatum extends BoxPlotDatum> extends Pick<BoxPlotCommonProps<RawDatum>, 'layout' | 'borderRadius' | 'borderWidth' | 'medianWidth' | 'whiskerWidth' | 'whiskerEndSize' | 'isInteractive' | 'tooltip'>, BoxPlotHandlers<SVGRectElement> {
...
export type RenderBoxPlotProps<RawDatum extends BoxPlotDatum> = Omit<BoxPlotItemProps<RawDatum>, 'isInteractive' | 'style' | 'tooltip' | 'isFocusable' | 'ariaLabel' | 'ariaLabelledBy' | 'ariaDescribedBy'> & {
    borderColor: string;
    labelColor: string;
};
...
export type BoxPlotSvgProps<RawDatum extends BoxPlotDatum> = Partial<BoxPlotCommonProps<RawDatum>> & DataProps<RawDatum> & BoxPlotHandlers<SVGRectElement> & SvgDefsAndFill<ComputedBoxPlotSummary> & Dimensions & MotionProps & Partial<{
    ...
    boxPlotAriaLabelledBy?: (data: ComputedBoxPlotSummary) => React.AriaAttributes['aria-labelledby'];
    boxPlotAriaDescribedBy?: (data: ComputedBoxPlotSummary) => React.AriaAttributes['aria-describedby'];
}>;
